...
export const PRODUCTS = [
  ...
  },
  {
    ...
    description:
      'Горячий напиток на основе эспрессо с увеличенной порцией молока и кокосовым сиропом',
    categoryId: 5,
...
export const PRODUCTS_WITH_VARIANTS = [
  {
    ...
    categoryId: 1,
    imageUrl: 'https://media.dodostatic.net/image/r:292x292/11EE7D610D2925109AB2E1C92CC5383C.webp',
  },
  {
    name: 'Ветчина и сыр',
    description: 'Ветчина, моцарелла, фирменный соус альфредо',
    categoryId: 1,
    imageUrl: 'https://media.dodostatic.net/image/r:292x292/11EE7D60FDA22358AC33C6A44EB093A2.webp',
  },
  {
    name: 'Карбонара',
    description:
